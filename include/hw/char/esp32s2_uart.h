...
#define TYPE_ESP32S2_UART "esps2_soc.uart"
#define ESP32S2_UART(obj) OBJECT_CHECK(ESP32S2UARTState, (obj), TYPE_ESP32S2_UART)
...
REG32(UART_FSM_STATUS, 0x68)
    FIELD(UART_FSM_STATUS, ST_URX_OUT, 0, 4)
    FIELD(UART_FSM_STATUS, ST_UTX_OUT, 4, 4)


REG32(UART_DATE, 0x74)

/* Size of the register file */
#define UART_REG_CNT (R_UART_DATE + 1)


typedef struct ESP32S2UARTState {
