...
#define TYPE_ESP32S2_EFUSE "nvram.esp32s2.efuse"
#define ESP32S2_EFUSE(obj) OBJECT_CHECK(Esp32S2EfuseState, (obj), TYPE_ESP32S2_EFUSE)

REG32(EFUSE_BLK0_RDATA0, 0x2c)
REG32(EFUSE_BLK1_RDATA0, 0x44)
REG32(EFUSE_BLK2_RDATA0, 0x5C)
REG32(EFUSE_BLK3_RDATA0, 0x7C)
REG32(EFUSE_BLK4_RDATA0, 0x9C)
REG32(EFUSE_BLK10_RDATA7, 0x0178)
REG32(EFUSE_PGM_DATA_0, 0x00)
REG32(EFUSE_CLK, 0x1c8)
REG32(EFUSE_STATUS, 0x1d0)
REG32(EFUSE_RD_WR_DIS,0x2c)
REG32(EFUSE_RD_REPEAT_DATAO,0x30)
REG32(EFUSE_RD_REPEAT_DATA1,0x34)
REG32(EFUSE_RD_REPEAT_DATA2,0x38)
REG32(EFUSE_RD_REPEAT_DATA3,0x3c)
REG32(EFUSE_RD_MAC_SPI_SYS_0,0x44)
REG32(EFUSE_RD_MAC_SPI_SYS_1,0x48)
REG32(EFUSE_RD_MAC_SPI_SYS_3,0x50)
REG32(EFUSE_RD_REPEAT_ERRO,0x17c)
REG32(EFUSE_CONF,0x1cc)
REG32(EFUSE_CMD,0x1d4)
REG32(EFUSE_INT_RAW,0x1d8)
REG32(EFUSE_INT_ST,0x1dc)
REG32(EFUSE_INT_ENA,0x1e0)
REG32(EFUSE_INT_CLR,0x1e4)
//REG32(EFUSE_DEC_STATUS, 0x1d0)
REG32(EFUSE_DAC_CONF,0x1e8)
REG32(EFUSE_RD_TIM_CONF,0x1ec)
...
typedef struct Esp32S2EfuseState {
