...
*/
#define S2_DR_REG_SYSTEM_BASE                      0x3f4c0000
#define S2_DR_REG_SENSITIVE_BASE                   0x3f4c1000
#define S2_DR_REG_INTERRUPT_BASE                   0x3f4c2000
#define S2_DR_REG_DMA_COPY_BASE                    0x3f4c3000
#define S2_DR_REG_EXTMEM_BASE                      0x61800000
#define S2_DR_REG_MMU_TABLE                        0x61801000
#define S2_DR_REG_ITAG_TABLE                       0x61802000
#define S2_DR_REG_DTAG_TABLE                       0x61803000
#define S2_DR_REG_AES_BASE                      0x6003a000
#define S2_DR_REG_SHA_BASE                      0x6003b000
#define S2_DR_REG_RSA_BASE                         0x6003c000
#define S2_DR_REG_HMAC_BASE                        0x6003e000
#define S2_DR_REG_DIGITAL_SIGNATURE_BASE           0x6003d000
#define S2_DR_REG_CRYPTO_DMA_BASE                  0x6003f000
#define S2_DR_REG_ASSIST_DEBUG_BASE                0x3f4ce000
#define S2_DR_REG_DEDICATED_GPIO_BASE              0x3f4cf000
#define S2_DR_REG_INTRUSION_BASE                   0x3f4d0000
#define S2_DR_REG_DPORT_END                        0x3f4d3FFC
#define S2_DR_REG_UART_BASE                        0x3f400000
#define S2_DR_REG_SPI1_BASE                        0x3f402000
#define S2_DR_REG_SPI0_BASE                        0x3f403000
#define S2_DR_REG_GPIO_BASE                        0x3f404000
#define S2_DR_REG_GPIO_SD_BASE                     0x3f404f00
#define S2_DR_REG_FE2_BASE                         0x3f405000
#define S2_DR_REG_FE_BASE                          0x3f406000
#define S2_DR_REG_FRC_TIMER_BASE                   0x3f407000
#define S2_DR_REG_RTCCNTL_BASE                     0x3f408000
#define S2_DR_REG_RTCIO_BASE                       0x3f408400
#define S2_DR_REG_SENS_BASE                        0x3f408800
#define S2_DR_REG_RTC_I2C_BASE                     0x3f408C00
#define S2_DR_REG_IO_MUX_BASE                      0x3f409000
#define S2_DR_REG_HINF_BASE                        0x3f40B000
#define S2_DR_REG_I2S_BASE                         0x3f40F000
#define S2_DR_REG_UART1_BASE                       0x3f410000
#define S2_DR_REG_I2C_EXT_BASE                     0x3f413000
#define S2_DR_REG_UHCI0_BASE                       0x3f414000
#define S2_DR_REG_SLCHOST_BASE                     0x3f415000
#define S2_DR_REG_RMT_BASE                         0x3f416000
#define S2_DR_REG_PCNT_BASE                        0x3f417000
#define S2_DR_REG_SLC_BASE                         0x3f418000
#define S2_DR_REG_LEDC_BASE                        0x3f419000
#define S2_DR_REG_MCP_BASE                         0x3f4c3000
#define S2_DR_REG_EFUSE_BASE                       0x3f41A000
#define S2_DR_REG_NRX_BASE                         0x3f41CC00
#define S2_DR_REG_BB_BASE                          0x3f41D000
#define S2_DR_REG_TIMERGROUP0_BASE                 0x3f41F000
#define S2_DR_REG_TIMERGROUP1_BASE                 0x3f420000
#define S2_DR_REG_RTC_SLOWMEM_BASE                 0x3f421000
#define S2_DR_REG_SYSTIMER_BASE                    0x3f423000
#define S2_DR_REG_SPI2_BASE                        0x3f424000
#define S2_DR_REG_SPI3_BASE                        0x3f425000
#define S2_DR_REG_SYSCON_BASE                      0x3f426000
#define S2_DR_REG_APB_CTRL_BASE                    0x3f426000    /* Old name for SYSCON, to be removed */
#define S2_DR_REG_I2C1_EXT_BASE                    0x3f427000
#define S2_DR_REG_SPI4_BASE                        0x3f437000
#define S2_DR_REG_USB_WRAP_BASE                    0x3f439000
#define S2_DR_REG_APB_SARADC_BASE                  0x3f440000
#define S2_DR_REG_USB_BASE                         0x60080000
...
#define REG_UHCI_BASE(i)         (S2_DR_REG_UHCI0_BASE)
#define REG_UART_BASE( i )  (S2_DR_REG_UART_BASE + (i) * 0x10000 )
#define REG_UART_AHB_BASE(i)  (0x60000000 + (i) * 0x10000 )
#define UART_FIFO_AHB_REG(i)  (REG_UART_AHB_BASE(i) + 0x0)
#define REG_I2S_BASE( i ) (S2_DR_REG_I2S_BASE)
#define REG_TIMG_BASE(i)              (S2_DR_REG_TIMERGROUP0_BASE + (i)*0x1000)
#define REG_SPI_MEM_BASE(i)     (S2_DR_REG_SPI0_BASE - (i) * 0x1000)
#define REG_I2C_BASE(i)    (S2_DR_REG_I2C_EXT_BASE + (i) * 0x14000 )
...
#define    ETS_RWBT_INTR_SOURCE6     7                  /**< interrupt of RWBT, level*/
...
#define    ETS_SHA_INTR_SOURCE              55            /**< interrupt of SHA accelerator, level*/
#define    ETS_AES_INTR_SOURCE              56              /**< interrupt of AES accelerator, level*/
#define    ETS_SPI2_DMA_INTR_SOURCE         57           /**< interrupt of SPI2 DMA, level*/
#define    ETS_SPI3_DMA_INTR_SOURCE         58           /**< interrupt of SPI3 DMA, level*/
#define    ETS_WDT_INTR_SOURCE              59           /**< will be cancelled*/
#define    ETS_TIMER1_INTR_SOURCE           60           /**< will be cancelled*/
#define    ETS_TIMER2_INTR_SOURCE           61          /**< will be cancelled*/
#define    ETS_TG0_T0_EDGE_INTR_SOURCE      62           /**< interrupt of TIMER_GROUP0, TIMER0, EDGE*/
#define    ETS_TG0_T1_EDGE_INTR_SOURCE      63           /**< interrupt of TIMER_GROUP0, TIMER1, EDGE*/

#define    ETS_TG0_WDT_EDGE_INTR_SOURCE     64          /**< interrupt of TIMER_GROUP0, WATCH DOG, EDGE*/
#define    ETS_TG0_LACT_EDGE_INTR_SOURCE    65          /**< interrupt of TIMER_GROUP0, LACT, EDGE*/
#define    ETS_TG1_T0_EDGE_INTR_SOURCE      66          /**< interrupt of TIMER_GROUP1, TIMER0, EDGE*/
#define    ETS_TG1_T1_EDGE_INTR_SOURCE      67          /**< interrupt of TIMER_GROUP1, TIMER1, EDGE*/
#define    ETS_TG1_WDT_EDGE_INTR_SOURCE     68          /**< interrupt of TIMER_GROUP1, WATCHDOG, EDGE*/
#define    ETS_TG1_LACT_EDGE_INTR_SOURCE    69          /**< interrupt of TIMER_GROUP0, LACT, EDGE*/
#define    ETS_CACHE_IA_INTR_SOURCE         70          /**< interrupt of Cache Invalied Access, LEVEL*/
#define    ETS_SYSTIMER_TARGET0_EDGE_INTR_SOURCE  71      /**< interrupt of system timer 0, EDGE*/
#define    ETS_SYSTIMER_TARGET1_EDGE_INTR_SOURCE  72      /**< interrupt of system timer 1, EDGE*/
#define    ETS_SYSTIMER_TARGET2_EDGE_INTR_SOURCE  73      /**< interrupt of system timer 2, EDGE*/
#define    ETS_ASSIST_DEBUG_INTR_SOURCE           74     /**< interrupt of Assist debug module, LEVEL*/
#define    ETS_PMS_PRO_IRAM0_ILG_INTR_SOURCE      75     /**< interrupt of illegal IRAM1 access, LEVEL*/
#define    ETS_PMS_PRO_DRAM0_ILG_INTR_SOURCE      76     /**< interrupt of illegal DRAM0 access, LEVEL*/
#define    ETS_PMS_PRO_DPORT_ILG_INTR_SOURCE      77     /**< interrupt of illegal DPORT access, LEVEL*/
#define    ETS_PMS_PRO_AHB_ILG_INTR_SOURCE        78     /**< interrupt of illegal AHB access, LEVEL*/
#define    ETS_PMS_PRO_CACHE_ILG_INTR_SOURCE      79     /**< interrupt of illegal CACHE access, LEVEL*/

#define    ETS_PMS_DMA_APB_I_ILG_INTR_SOURCE      80     /**< interrupt of illegal APB access, LEVEL*/
#define    ETS_PMS_DMA_RX_I_ILG_INTR_SOURCE       81     /**< interrupt of illegal DMA RX access, LEVEL*/
#define    ETS_PMS_DMA_TX_I_ILG_INTR_SOURCE       82     /**< interrupt of illegal DMA TX access, LEVEL*/
#define    ETS_SPI_MEM_REJECT_CACHE_INTR_SOURCE   83     /**< interrupt of SPI0 Cache access and SPI1 access rejected, LEVEL*/
...
#define    ETS_ICACHE_PRELOAD_INTR_SOURCE         87     /**< interrupt of ICache perload operation, LEVEL*/
#define    ETS_DCACHE_PRELOAD_INTR_SOURCE         88     /**< interrupt of DCache preload operation, LEVEL*/
#define    ETS_APB_ADC_INTR_SOURCE                89     /**< interrupt of APB ADC, LEVEL*/
#define    ETS_CRYPTO_DMA_INTR_SOURCE             90     /**< interrupt of encrypted DMA, LEVEL*/
#define    ETS_CPU_PERI_ERROR_INTR_SOURCE         91     /**< interrupt of CPU peripherals error, LEVEL*/
#define    ETS_APB_PERI_ERROR_INTR_SOURCE         92     /**< interrupt of APB peripherals error, LEVEL*/
#define    ETS_DCACHE_SYNC_INTR_SOURCE            93     /**< interrupt of data cache sync done, LEVEL*/
#define    ETS_ICACHE_SYNC_INTR_SOURCE            94     /**< interrupt of instruction cache sync done, LEVEL*/
#define    ETS_MAX_INTR_SOURCE                    95     /**< number of interrupt sources */
#endif 
...
#define ESP32S2_INT_MATRIX_OUTPUTS    45
#define ESP32S2_INT_MATRIX_INPUTS     69
#define ESP32S2_CPU_COUNT             1
#define ESP32S2_UART_COUNT            2
#define ESP32S2_FRC_COUNT             2
#define ESP32S2_TIMG_COUNT            2
#define ESP32S2_SPI_COUNT             4
#define ESP32S2_RTC_CNTL_SCRATCH_REG_COUNT     8
